"""
Tests automáticos para network_guard.py

Verifican la lógica de detección de puertos riesgosos y patrones de
escaneo/exfiltración, sin necesitar tráfico de red real ni admin.

Correr con:
    python -m pytest test_network_guard.py -v
"""
